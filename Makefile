libstub-pixbuf-pixbuf.so:stub-pixbuf.o 
	gcc -shared -pthread -Wl,-z,noexecstack -Wl,-soname,libstub-pixbuf.so -o libstub-pixbuf.so -Wl,--start-group stub-pixbuf.o ../../out/Default/obj.target/libppapi_cpp.a ../../out/Default/obj.target/libppapi_cpp_objects.a -Wl,--end-group  -I /home/bxl/ -g -lcairo -lm
